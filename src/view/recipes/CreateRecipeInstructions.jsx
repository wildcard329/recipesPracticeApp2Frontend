            ...
            <FormGroup>
                <ul>
                    <li onClick={editInstruction1}>
                        <textarea id='instruction1' placeholder='instruction' type='text' name='instruction1' onChange={handleInstructions} onBlur={sendInstruction1Props} className={instruction1IsEntered ? 'none' : 'create-recipe-item'} />
                    ...
                    <li onClick={editInstruction2}>
                        <textarea id='instruction2' placeholder='instruction' type='text' name='instruction2' onChange={handleInstructions} onBlur={sendInstruction2Props} className={instruction2IsEntered ? 'none' : 'create-recipe-item'} />
                    ...
                    <li onClick={editInstruction3}>
                        <textarea id='instruction3' placeholder='instruction' type='text' name='instruction3' onChange={handleInstructions} onBlur={sendInstruction3Props} className={instruction3IsEntered ? 'none' : 'create-recipe-item'} />
                    ...
                    <li onClick={editInstruction4}>
                        <textarea id='instruction4' placeholder='instruction' type='text' name='instruction4' onChange={handleInstructions} onBlur={sendInstruction4Props} className={instruction4IsEntered ? 'none' : 'create-recipe-item'} />
                    ...
                    <li onClick={editInstruction5}>
                        <textarea id='instruction5' placeholder='instruction' type='text' name='instruction5' onChange={handleInstructions} onBlur={sendInstruction5Props} className={instruction5IsEntered ? 'none' : 'create-recipe-item'} />
